...
open class MatchListAdapter(val clickListener: MatchClickListener) :
    ListAdapter<MatchItem, MatchListAdapter.ViewHolder>(MatchesDiffCallback()) {
    ...
    class ViewHolder private constructor(val binding: ItemMatchesBinding) :
    ...
    class MatchClickListener(
        val acceptListener: (match: MatchItem) -> Unit,
